...
import { LayoutDashboard, Table, ClipboardList, LogOut, Menu, X } from 'lucide-react';
...
const WaiterLayout: React.FC = () => {
  ...
  const navigation = [
    ...
    { name: 'Tables', href: '/waiter/tables', icon: Table },
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      {sidebarOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          />
          <div className="fixed inset-y-0 left-0 flex flex-col w-64 bg-green-800">
            <div className="flex items-center justify-between h-16 px-4 bg-green-900">
              <span className="text-white font-bold text-lg">Waiter</span>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:flex-col lg:w-64 bg-green-800">
